                                ...
                                <div class="scroll-y mh-200px mh-lg-350px">
                                        ...
                                        <div class="symbol symbol-40px me-4">
															<span class="symbol-label bg-light">
																<img class="w-20px h-20px"
                                                                     src="assets/admin/media/svg/brand-logos/volicity-9.svg"
                                                                     alt=""/>
															</span>
                                        </div>
                                        <!--end::Symbol-->
                                    ...
                                    <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                        ...
                                        <div class="symbol symbol-40px me-4">
															<span class="symbol-label bg-light">
																<img class="w-20px h-20px"
                                                                     src="assets/admin/media/svg/brand-logos/tvit.svg"
                                                                     alt=""/>
															</span>
                                        </div>
                                        <!--end::Symbol-->
                                    ...
                                    <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                        ...
                                        <div class="symbol symbol-40px me-4">
															<span class="symbol-label bg-light">
																<img class="w-20px h-20px"
                                                                     src="assets/admin/media/svg/misc/infography.svg"
                                                                     alt=""/>
															</span>
                                        </div>
                                        <!--end::Symbol-->
                                    ...
                                    <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                        ...
                                        <div class="symbol symbol-40px me-4">
															<span class="symbol-label bg-light">
																<img class="w-20px h-20px"
                                                                     src="assets/admin/media/svg/brand-logos/leaf.svg"
                                                                     alt=""/>
															</span>
                                        </div>
                                        <!--end::Symbol-->
                                    ...
                                    <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                        ...
                                        <div class="symbol symbol-40px me-4">
															<span class="symbol-label bg-light">
																<img class="w-20px h-20px"
                                                                     src="assets/admin/media/svg/brand-logos/tower.svg"
                                                                     alt=""/>
															</span>
                                        </div>
                                        <!--end::Symbol-->
                            ...
                            <div class="d-flex flex-column px-9">
                                ...
                                <div class="text-center px-4">
                                    <img class="mw-100 mh-200px" alt="image"
                                         src="assets/admin/media/illustrations/sketchy-1/1.png"/>
                                </div>
                                <!--end::Illustration-->
                            </div>
                            <!--end::Wrapper-->
                    ...
                    <div class="menu-item px-5" data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                        ...
                        <a href="#" class="menu-link px-5">
											...
											<img class="w-15px h-15px rounded-1 ms-2"
                                                 src="assets/admin/media/flags/united-states.svg" alt=""/></span></span>
                        </a>
                        <!--begin::Menu sub-->
                        <div class="menu-sub menu-sub-dropdown w-175px py-4">
                            <!--begin::Menu item-->
                            @foreach(Config::get('language') as $lang=>$language)
                                <div class="menu-item px-3">
                                    <a href="{{route("lang.switch",$lang)}}"
                                       class="menu-link d-flex px-5 {{app()->getLocale() == $lang ? "active" :""}}">

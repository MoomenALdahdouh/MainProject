    ...
    <div id="kt_app_sidebar_wrapper" class="app-sidebar-wrapper hover-scroll-y my-5 my-lg-2" data-kt-scroll="true"
        ...
        <div id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false"
            ...
            <div data-kt-menu-trigger="click"
                 class="menu-item here {{str_contains(url()->current(),url("/")) ?"show":""}} menu-accordion">
                <!--begin:Menu link-->
            ...
            <!--begin:Menu item-->
            <div data-kt-menu-trigger="click"
                 class="menu-item here {{str_contains(url()->current(),url('admin/users')) || str_contains(url()->current(),url('admin/roles')) ?"show":""}} menu-accordion">
                <!--begin:Menu link-->
                <span class="menu-link">
										<span class="menu-icon">
											<i class="fonticon-house fs-2"></i>
                ...
                <div class="menu-sub menu-sub-accordion">
                    ...
                    @can('admin_users')
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link {{ str_contains(url()->current(),route('admin.users.index')) ? "active" : ""}}"
                    ...
                    <div class="menu-item">
                        <!--begin:Menu link-->
                        <a class="menu-link {{ str_contains(url()->current(),route('admin.roles.index')) ? "active" : ""}}"

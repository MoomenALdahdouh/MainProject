				...
				<div class="d-flex flex-column flex-lg-row-fluid w-lg-50 p-10 order-2 order-lg-1">
					...
					<div class="d-flex flex-center flex-column flex-lg-row-fluid">
						...
						<div class="w-lg-500px p-10">
							<!--begin::Form-->
							<form class="form w-100" novalidate="novalidate" id="kt_sign_up_form" data-kt-redirect-url="../../demo39/dist/authentication/layouts/corporate/sign-in.html" action="#">
								<!--begin::Heading-->
								...
								<a href="../../demo39/dist/authentication/layouts/corporate/sign-in.html" class="link-primary fw-semibold">Sign in</a></div>
								<!--end::Sign up-->
							</form>
							<!--end::Form-->
						</div>

                    ...
                    <div class="modal-body scroll-y mx-lg-5 my-7">
                        ...
                        data-type="render">
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="d-flex">
                                                            ...
                                                            <label class="form-check form-check-sm form-check-custom form-check-solid me-5 me-lg-20">
                                                                <input class="form-check-input" type="checkbox" value="{{$permission->name}}_read" name="permissions[{{$permission->name}}][read]" />
                                                                <span class="form-check-label">Read</span>
                                                            </label>
                                                            <!--end::Checkbox-->
                                                            <!--begin::Checkbox-->
                                                            <label class="form-check form-check-sm form-check-custom form-check-solid me-5 me-lg-20">
                                                                <input class="form-check-input" type="checkbox" value="{{$permission->name}}_write" name="permissions[{{$permission->name}}][write]" />
                                                                <span class="form-check-label">Write</span>
                                                            </label>
                                                            <!--end::Checkbox-->
                                                            <!--begin::Checkbox-->
                                                            <label class="form-check form-check-sm form-check-custom form-check-solid me-5 me-lg-20">
                                                                <input class="form-check-input" type="checkbox" value="{{$permission->name}}_create" name="permissions[{{$permission->name}}][create]" />
                                                                <span class="form-check-label">Create</span>
                                                            </label>
                                                            <!--end::Checkbox-->
                                                            <!--begin::Checkbox-->
                                                            <label class="form-check form-check-sm form-check-custom form-check-solid">
                                                                <input class="form-check-input" type="checkbox" value="{{$permission->name}}_delete" name="permissions[{{$permission->name}}][delete]" />
                            ...
                            <div class="text-center pt-15">
                                ...
                                <button id="submit_button" type="submit" class="btn btn-primary" data-kt-roles-modal-action="submit">

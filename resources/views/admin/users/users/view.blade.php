											...
											<div class="menu-sub menu-sub-accordion">
												...
												<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion mb-1">
													...
													<div class="menu-sub menu-sub-accordion">
														...
														<div class="menu-item">
															<!--begin:Menu link-->
															<a class="menu-link active" href="../../demo39/dist/apps/user-management/users/view.html">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
												...
												<div class="card-body">
													...
													<div id="kt_user_view_details" class="collapse show">
														<div class="pb-5 fs-6">
															...
															<div class="text-gray-600">22 Sep 2023, 10:10 pm</div>
															<!--begin::Details item-->
														</div>
													</div>
													<!--end::Details content-->
																...
																<table class="table align-middle table-row-dashed fw-semibold text-gray-600 fs-6 gy-5" id="kt_table_users_logs">
																	...
																	<tbody>
																		...
																		<tr>
																			...
																			<!--end::Badge=-->
																			<!--begin::Status=-->
																			<td>POST /v1/invoice/in_2303_7588/invalid</td>
																			<!--end::Status=-->
																			<!--begin::Timestamp=-->
																		...
																		<tr>
																			...
																			<!--end::Badge=-->
																			<!--begin::Status=-->
																			<td>POST /v1/invoices/in_5828_4565/payment</td>
																			<!--end::Status=-->
																			<!--begin::Timestamp=-->
																			<td class="pe-0 text-end min-w-200px">25 Oct 2023, 10:30 am</td>
																			<!--end::Timestamp=-->
																		</tr>
																		<!--end::Table row-->
																		<!--begin::Table row-->
																		...
																		<tr>
																			...
																			<!--end::Badge=-->
																			<!--begin::Status=-->
																			<td>POST /v1/invoices/in_7473_4918/payment</td>
																			<!--end::Status=-->
																			<!--begin::Timestamp=-->
															...
															<table class="table align-middle table-row-dashed fs-6 text-gray-600 fw-semibold gy-5" id="kt_table_customers_events">
																...
																<tbody>
																	...
																	<tr>
																		...
																		<!--end::Event=-->
																		<!--begin::Timestamp=-->
																		<td class="pe-0 text-gray-600 text-end min-w-200px">15 Apr 2023, 2:40 pm</td>
																		<!--end::Timestamp=-->
																	</tr>
																	<!--end::Table row-->
																	<!--begin::Table row-->
																	...
																	<tr>
																		...
																		<!--end::Event=-->
																		<!--begin::Timestamp=-->
																		<td class="pe-0 text-gray-600 text-end min-w-200px">25 Oct 2023, 10:10 pm</td>
																		<!--end::Timestamp=-->
																	</tr>
																	<!--end::Table row-->
																</tbody>
